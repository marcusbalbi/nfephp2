 ...
 */
class icmsCons implements NFeGeradorInterface {
    public $vBCICMSSTCons; // L118 - BC do ICMS ST da UF de consumo
    public $vICMSSTCons;   // L119 - valor do ICMS ST da UF de consumo
    public $UFcons;        // L120 - sigla da UF de consumo
