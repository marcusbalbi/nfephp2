...
class icms implements NFeGeradorInterface {
    public $orig;      // N11 - origem da mercadoria
    public $CST;       // N12 - tributação do ICMS
    public $modBC;     // N13 - modalidade de determinação da BC do ICMS
    public $pRedBC;    // N14 - percentual da redução de BC
    public $vBC;       // N15 - valor da BC do ICMS
    public $pICMS;     // N16 - alíquota do imposto
    public $vICMS;     // N17 - valor do ICMS
    public $modBCST;   // N18 - modalidade de determinação da BC do ICMS ST
    public $pMVAST;    // N19 - percentual da margem de valor adicionado do ICMS ST
    public $pRedBCST;  // N20 - percentual da redução de BC do ICMS ST
    public $vBCST;     // N21 - valor da BC do ICMS ST
    public $pICMSST;   // N22 - alíquota do imposto do ICMS ST
    public $vICMSST;   // N23 - valor do ICMS ST

	
    // Alteracao para atender ao Simples Nacional - NFe2.0 (Osmar 29/12/2011 osmarfilho6@gmail.com)                
    public $CSOSN;			// N12a - Código de Situação da Operação – Simples Nacional
    public $vBCSTRet;  	// N26  - Valor da BC do ICMS ST cobrado anteriormente por ST
    public $vICMSSTRet;	// N27  - Valor do ICMS ST cobrado anteriormente por ST
    public $pCredSN;		// N29	- Alíquota aplicável de cálculo do crédito (Simples Nacional).
    public $vCredICMSSN;	// N30	- Valor crédito do ICMS que pode ser aproveitado nos termos do art. 23 da LC 123 (Simples Nacional)
    ...
    public function getXml(DOMDocument $dom)
    {
        ...
        switch ($this->CST) {
            ...
            case '90' :
                ...
                break;
            default :
                $this->CSOSN = $this->CST; //caso o CST NAO SEJA NENHUM DOS ACIMA ELE JOGA PARA O CSOSN 
                break;
